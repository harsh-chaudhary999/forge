---
name: "source-command-forge-install"
description: "Show Forge plugin installation instructions for Cursor, Codex, Antigravity, CLIs, and JetBrains — paths and scripts in this repo only."
---

# source-command-forge-install

Use this skill when the user asks to run the migrated source command `forge-install`.
...
### Codex (Auto)
Forge is auto-detected as a plugin. Restart Codex to activate.
