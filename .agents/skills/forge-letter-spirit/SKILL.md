...
| "Vague scale (~60+ items) is honest enough for scans / plans / tests" | **Not honest enough.** Letter **and** spirit require **what / where / how** — paths, anchors, commands — not counts alone. **AGENTS.md** / **AGENTS.md** — *Written artifacts — precision*. |
