# Skill authoring — deep dive, anti-patterns & worked examples (reference for `forge-skill-anatomy`)

> Progressive-disclosure Level 3 (loaded on demand). The per-type deep dive, the five authoring anti-patterns, the skill-authoring edge cases, and full GOOD/BAD worked examples. The SKILL.md is the operational guide; this is the depth.
