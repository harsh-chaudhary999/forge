...
| **Core concepts** | [`reference/core-concepts.md`](reference/core-concepts.md) | shared-dev-spec.md; product.md; worktree-per-project-per-task (D30); Brain Directory Structure; prd-locked.md; terminology.md; Skill; Rigid Skill; Flexible Skill; Red Flag; Anti-Pattern; HARD-GATE; Superpowers; Phase; Batch; P0/P1/P2/P3; Seed Product; Surface; Discipline; Contract; Driver; Escalation |
