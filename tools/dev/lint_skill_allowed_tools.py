...
Optional --write-policy emits tools/dev/skill-tool-policy.json for hosts that can
...
def main() -> int:
    ...
    ap.add_argument(
        "--write-policy",
        default=None,
        help="Write skill-tool-policy.json to this path (e.g. tools/dev/skill-tool-policy.json)",
    )
    args = ap.parse_args()
