---
description: "Generate per-project tech plans with bite-sized tasks from the shared dev spec"
---

Invoke the `tech-plan-write-per-project` skill to generate implementation plans.
