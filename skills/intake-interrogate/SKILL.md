...
Elicit in **doubt order, not ritual order**. The full Q1–Q9 catalog (each dimension's elicitation prompts and lock criteria) is in [reference/lock-dimensions.md](reference/lock-dimensions.md).
