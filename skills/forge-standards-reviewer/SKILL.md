...
Emit findings using the standard template (severity, rule id, file:line, fix) — full format spec in [reference/findings-format.md](reference/findings-format.md).
