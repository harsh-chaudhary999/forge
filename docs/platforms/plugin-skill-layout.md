...
After **`git pull`** in your Forge repo, **re-run `install.sh` for each IDE** you use so merged `skills/` trees are replaced — see **[README §4 — Keeping Forge updated](../../README.md#4-keeping-forge-updated-how-you-hear-about-changes)** and the other pages under **`docs/platforms/`**.
