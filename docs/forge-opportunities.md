...
|---|---|---|
| **QA owns staging; dev owns feature flags** | Standalone **`/qa`** vs **`/forge`** fork confusion | Already documented in README; optional **decision tree** command or **`forge-product.md` flag** `qa_track: delivery | standalone` |
...
|---|---|
| **Multi-repo truth** | Already core: **`forge-product.md`**, cross-repo eval — keep stress-testing monorepo + polyrepo |
