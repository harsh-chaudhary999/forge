        ...
        node.write_text(
            "\n".join(
                [
                    ...
                    "",
                    "## Key Methods",
                    f"_See [[methods/]] — auto stubs use `{role}-m-<cksum>` (full inventory); optional hand nodes `{role}-{cls}-<method>`._",
                    "",
                    "## Extends / Implements",
            ...
            node.write_text(
                "\n".join(
                    [
                        ...
                        f"**Class hub:** _See [[classes/]] for types in `{rel_file}` — link the owning class during enrich._",
                        f"**File:** `{rel_file}:{lineno}`",
                        f"**Language:** {lang}",
        ...
        node.write_text(
            "\n".join(
                [
                    ...
                    f"_See [[classes/]] for individual class nodes with prefix `{role}-`_",
                    "",
                    "## Exports",
